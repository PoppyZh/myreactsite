        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">Poppy Zhang</a></h1>
              <span className="email"><i className="icon-mail"></i> qianyunzhangmkt@gmail.com</span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                ...
                <li><a href="https://www.linkedin.com/in/poppyzhang" target="_blank" rel="noopener noreferrer"><i className="icon-linkedin2" /></a></li>
                <li><a href="https://github.com/poppyzh" target="_blank" rel="noopener noreferrer"><i className="icon-github"></i></a></li>
